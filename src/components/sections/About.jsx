                ...
                <div className='max-w-3xl mx-auto px-4'>
                    ...
                    <div className='rounded-xl p-8 border-white/10 border hover:translate-y-1 transition-all'>
                        <p className='text-gray-300 mb-6'>
                            Passionate developer in creating applications and scaliumg them at the next level, your all meets in one place
                    ...
                    <div className='grid grid-cols-1 md:grid-cols-2 gap-6 mt-8'>
                        <div className='p-6 rounded-xl border-white/10 border hover:translate-y-1 transition-all'>
                            ...
                            <ul className='list-disc list-inside text-gray-300 space-y-2'>
                                <li>
                                    <strong>B.E in Computer Systems  </strong> -NED University (2023-2027)
                                </li>
                                <li>
                        ...
                        <div className='p-6 rounded-xl border-white/10 border hover:translate-y-1 transition-all'>
                            ...
                            <div className='space-y-4 text-gray-300'>
                                <div>
                                    ...
                                    <p>
                                        hbzlvbzlvdsdnkljcljkbndnBCGALN
                                    </p>
                                </div>
                            </div>
                        </div>
